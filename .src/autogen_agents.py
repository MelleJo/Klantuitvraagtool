...
def correction_AI(guidelines: str, email_result: str) -> str:
    ...
    Below is the email generated by an AI model:
    {email_result}

    Please check the email according to the guidelines provided. Correct any issues related to formality, subjective language, jargon, assumptions, and placeholders. Return the final, corrected email text.
    """
